...
import {NEXT_PAGE, PREV_PAGE} from "./redux/types";

function App({ beers, beersTotal, currentPage, loadBeers, nextPage, prevPage }) {
    ...
    <div className="App">
      ...
      <aside id="drawer" className={drawerOpen ? 'open' : null}>
        ...
        <footer className="drawer-footer">
          <section className="drawer-caption">
          ...
          2.78a.73.73 0 0 1-.6 0l-5.5-2.76z "></path>
              ...
              <li>
                <svg xmlns="http://www.w3.org/2000/svg " width="38 " height="38 " viewBox="0 0 38 38 ">
                  <g fill="none " fillRule="evenodd ">
                    <circle cx="19 " cy="19 " r="19 " fill="#B5B5B5 " fillRule="nonzero "></circle>
...
const mapStateToProps = (state) => ({
  beers: state.beers.results,
  beersTotal: state.beers.total,
  currentPage: state.UI.currentPage
})

const mapActionsToProps = (dispatch) => ({
  loadBeers: (currentPage) => dispatch(loadBeers(currentPage)),
